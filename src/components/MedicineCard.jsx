...
export default function MedicineCard({ med, medicine, addToCart, onAddToCart }) {
  ...
  return (
    <div style={{
      ...
      {/* Bottom Section: Name/Price on Left, Add Button on Right */}
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', gap: '8px' }}>
        
        {/* Left Side: Name and Price */}
        <div style={{ display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          <h3 
            style={{ margin: '0 0 4px 0', fontSize: '14px', fontWeight: '600', color: '#1f2937', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }} 
            title={name}
          >
            {name}
          </h3>
        ...
        <button
          ...
          style={{
            padding: '6px 16px',
            backgroundColor: isAvailable ? '#ff6f61' : '#e5e7eb',
